module.exports = {
  ...
  rules: {
    ...
    "no-unused-vars": ["error", {"argsIgnorePattern": "next"}], // desabilita a regra que nao permite a declaracao de variaveis que nao seram utilizadas, porm em alguns momentos teremos de declarar next mesmo que nao formos utiliza-la.
